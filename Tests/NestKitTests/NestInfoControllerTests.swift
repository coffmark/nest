...
struct NestInfoControllerTests {
    ...
    func fetch() throws {
        ...
        #expect(try nestInfoController.fetchCommand(referenceName: "owner/foo", version: "0.0.2") == commands[1])
        #expect(try nestInfoController.fetchCommand(referenceName: "owner/foo", version: "0.0.3") == nil)
    }
